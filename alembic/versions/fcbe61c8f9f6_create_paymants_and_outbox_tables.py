"""create paymants and outbox tables

Revision ID: fcbe61c8f9f6
Revises: 
Create Date: 2026-03-25 14:35:54.605926
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('new', 'published', 'failed', name='outbox_status'), server_default='new', nullable=False),
